...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: SessionTimerService$1, decorators: [{
        ...
        return [{ type: i1.HttpClient }, { type: i3.NotificationService, decorators: [{
                        type: Optional
                    }] }];
    } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: MuiHeadernavComponent, decorators: [{
        ...
        return [{ type: MuiHeadernavService }, { type: i2.MatDialog }, { type: i3.NotificationService, decorators: [{
                        type: Optional
                    }] }];
...
class MuiLeftnavService {
    ...
    loadSavedActiveNavItems() {
        ...
        return JSON.parse((_a = window.sessionStorage.getItem(this.sessionStorageKey)) !== null && _a !== void 0 ? _a : 'null');
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: MuiLeftnavComponent, decorators: [{
        ...
        return [{ type: MuiLeftnavService }, { type: i2$1.Router, decorators: [{
                        type: Optional
                    }] }];
    }, propDecorators: { apiUrl: [{
                type: Input
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: MuiDrawerComponent, decorators: [{
        ...
        return [{ type: i1$2.MatSidenav, decorators: [{
                        type: Optional
                    }] }];
    } });
/**
...
class EditPasswordComponent {
    ...
    ngOnInit() {
        this.form = this.fb.group({
            ...
            validators: control => {
                var _a;
                const psw = (_a = control.get('new_psw')) === null || _a === void 0 ? void 0 : _a.value;
                const pswConfirm = control.get('new_psw_confirm');
                const pswConfirmVal = pswConfirm === null || pswConfirm === void 0 ? void 0 : pswConfirm.value;
                if (pswConfirmVal.length > 0 && pswConfirmVal !== psw) {
                    const passwordMatchError = { noPasswordMatch: true };
                    pswConfirm === null || pswConfirm === void 0 ? void 0 : pswConfirm.setErrors(passwordMatchError);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: NotificationBellComponent, decorators: [{
        ...
        return [{ type: i3.NotificationService, decorators: [{
                        type: Optional
                    }] }];
...
class TopNavigationCacheService {
    ...
    getSessionIdFromRequest() {
        var _a;
        return (_a = window.location.pathname.match(/;jsessionid=[A-F0-9]{32}(?:;[a-z0-9]+)?/)) === null || _a === void 0 ? void 0 : _a[0];
    }
}
...
class SessionTimerService {
    ...
    init(navItem) {
        ...
        this.endpointUrl = (_a = navItem.href) !== null && _a !== void 0 ? _a : '';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: SessionTimerService, decorators: [{
        ...
        return [{ type: i1.HttpClient }, { type: i2.MatDialog }, { type: TopNavigationCacheService }, { type: i3.NotificationService, decorators: [{
                        type: Optional
                    }] }];
    } });
...
class TopNavigationService {
    ...
    initHelpLink(navData) {
        var _a, _b, _c;
        const helpItem = (_b = (_a = navData.auxNav.find(item => item.id === 'aux-help')) === null || _a === void 0 ? void 0 : _a.menu) === null || _b === void 0 ? void 0 : _b.find(item => item.id === 'aux-help-onlinehelp');
        this.helpBaseUrl = (_c = helpItem === null || helpItem === void 0 ? void 0 : helpItem.href) !== null && _c !== void 0 ? _c : '';
    }
    /**
    ...
    initActiveMenuSection(navData) {
        ...
        const findMatchingHref = (data, result) => {
            return data.some(val => {
                result.push(val.id);
                if (location === (val === null || val === void 0 ? void 0 : val.href)) {
                    return true;
                }
                else if (val.menu) {
...
class ProfileMenuComponent {
    ...
    openAccountDialog(item) {
        const config = {
            ...
            data: Object.assign(Object.assign({}, item.properties), { accountSettings: true })
        };
    ...
    setUserInitials() {
        var _a, _b;
        const userName = (_b = (_a = this.navItem) === null || _a === void 0 ? void 0 : _a.properties) === null || _b === void 0 ? void 0 : _b['userName'];
        if (userName) {
    ...
    initSessionTimer() {
        var _a, _b;
        const config = (_b = (_a = this.navItem) === null || _a === void 0 ? void 0 : _a.menu) === null || _b === void 0 ? void 0 : _b.find(itm => itm.id === 'aux-timer');
        if (config) {
    ...
    prepareLanguageMenu() {
        var _a, _b;
        const mainLangEntry = (_b = (_a = this.navItem) === null || _a === void 0 ? void 0 : _a.menu) === null || _b === void 0 ? void 0 : _b.find(itm => itm.id === 'aux-user-lang');
...
class TopNavMenuComponent {
    constructor(dialog, service, document, router) {
        ...
        this.isActiveMenu = false;
        this.baseHref = (_b = (_a = this.document.getElementsByTagName('base')) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.href;
    }
    onItemClicked(menuItem, event) {
        ...
        else if ((_a = menuItem.properties) === null || _a === void 0 ? void 0 : _a['blank']) {
            window.open(menuItem.href);
        }
        else if ((_b = menuItem.properties) === null || _b === void 0 ? void 0 : _b['modal']) {
    ...
    navigateTo(url) {
        ...
        if (/https?:\/{2}/.test(routingPath) || this.router.config.length === 0) {
            ...
            const navigateResult = this.router.navigateByUrl((_a = parsedUrl.fragment) !== null && _a !== void 0 ? _a : parsedUrl);
    ...
    openDialog(menuItem) {
        ...
        const config = {
            ...
            autoFocus: false,
            data: {
                title: (_a = menuItem.properties) === null || _a === void 0 ? void 0 : _a['title'],
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: TopNavMenuComponent, decorators: [{
        ...
        return [{ type: i2.MatDialog }, { type: TopNavigationService }, { type: Document, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
                    }] }, { type: i2$1.Router }];
