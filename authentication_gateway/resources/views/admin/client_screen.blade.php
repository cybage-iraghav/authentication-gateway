                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('createSystemUser') }}">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-6">
                              <input id="company_name" type="text" class="form-control @error('company_name') is-invalid @enderror" name="company_name" value="{{ old('name') }}">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-6">
                              <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('name') }}">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="reseller_id" class="col-md-4 col-form-label text-md-end">{{ __('Reseller') }}</label>
                            <div class="col-md-6">
                                <div class="form-select-wrapper">
                                    <select id="reseller_id" class="form-control form-select" name="reseller_id">
                                        <option value="">{{ __('--Select One') }}</option>
                                        @foreach ($resellers as $reseller)
                                            <option value="{{ $reseller->cloud_id }}">{{ $reseller->company_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
